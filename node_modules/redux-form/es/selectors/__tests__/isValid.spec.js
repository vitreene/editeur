...
var describeIsValid = function describeIsValid(name, structure, expect) {
  ...
  describe(name, function () {
    ...
    it('should return false when there is a global sync error', function () {
      expect(isValid('foo')(setIn(fromJS({
        form: {
          foo: {
            values: {
    ...
    it('should return false when there is a global async error', function () {
      expect(isValid('foo')(fromJS({
        form: {
          foo: {
            values: {
    ...
    it('should return false when there is a global submit error', function () {
      expect(isValid('foo')(fromJS({
        form: {
          foo: {
            values: {
