...
var describeIsInvalid = function describeIsInvalid(name, structure, expect) {
  ...
  describe(name, function () {
    ...
    it('should return true when there is a global sync error', function () {
      expect(isInvalid('foo')(setIn(fromJS({
        form: {
          foo: {
            values: {
    ...
    it('should return true when there is a global async error', function () {
      expect(isInvalid('foo')(fromJS({
        form: {
          foo: {
            values: {
    ...
    it('should return true when there is a global submit error', function () {
      expect(isInvalid('foo')(fromJS({
        form: {
          foo: {
            values: {
