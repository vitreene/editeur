...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uniq = __webpack_require__(38);
	...
	var App = function (_React$Component) {
	    ...
	    function App() {
	        ...
	        }, _this.simpleList = null, _temp), _possibleConstructorReturn(_this, _ret);
	    }
	
	    _createClass(App, [{
	        key: 'addMoreItems',
	        value: function addMoreItems() {
	            var items = ['Apple', 'Banana', 'Cherry', 'Guava', 'Grape', 'Kiwi', 'Lemon', 'Melon', 'Orange', 'Pear', 'Peach', 'Strawberry'];
	            var i = (0, _random2.default)(0, items.length - 1);
	        ...
	        value: function render() {
	            ...
	            var simpleList = this.state.simpleList.map(function (val, key) {
	            ...
	            var groupLeft = this.state.groupLeft.map(function (val, key) {
	                return _react2.default.createElement(
	                    'div',
	                    { key: key, 'data-id': val },
	                    val
	            ...
	            var groupRight = this.state.groupRight.map(function (val, key) {
	                return _react2.default.createElement(
	                    'div',
	                    { key: key, 'data-id': val },
	                    val
	            ...
	            var cloneUncontrolled = this.state.cloneUncontrolled.map(function (val, key) {
	                return _react2.default.createElement(
	                    'li',
	                    { key: key, 'data-id': val },
	                    val
	            ...
	            var cloneControlledSource = this.state.cloneControlledSource.map(function (val, key) {
	                return _react2.default.createElement(
	                    'li',
	                    { key: key, 'data-id': val },
	                    val
	            ...
	            var cloneControlledTarget = this.state.cloneControlledTarget.map(function (val, key) {
	                return _react2.default.createElement(
	                    'li',
	                    { key: key, 'data-id': val },
	                    val
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'container-fluid', style: { marginTop: 50 } },
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'title' },
	                        'Simple List'
	                        ...
	                        _react2.default.createElement(
	                            'button',
	                            {
	                                ...
	                                onClick: function onClick(e) {
	                                    var order = _this2.simpleList.toArray();
	                                    _this2.simpleList.sort(order.reverse());
	                                }
	                            },
	                            'Reverse Order'
	                        )
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'title', style: { marginTop: 50 } },
	                        'Shared Group'
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        ...
	                        _react2.default.createElement(
	                            'button',
	                            {
	                                type: 'button',
	                                className: 'btn btn-default',
	                                onClick: this.addMoreItems.bind(this)
	                            },
	                            'Add more items'
	                        )
	                    ),
	                            ...
	                            _react2.default.createElement(
	                                _src2.default,
	                                {
	                                    ...
	                                    onChange: function onChange(items) {
	                                        _this2.setState({ groupLeft: items });
	                                    }
	                                },
	                                groupLeft
	                            )
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                _src2.default,
	                                {
	                                    ...
	                                    className: 'block-list',
	                                    onChange: function onChange(items) {
	                                        _this2.setState({ groupRight: items });
	                                    },
	                                    ref: 'group-right'
	                                },
	                                groupRight
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                _src2.default,
	                                {
	                                    ...
	                                    className: 'block-list',
	                                    onChange: function onChange(items) {
	                                        _this2.setState({ cloneControlledSource: items });
	                                    },
	                                    tag: 'ul'
	                                },
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                _src2.default,
	                                {
	                                    ...
	                                    className: 'block-list',
	                                    onChange: function onChange(items) {
	                                        items = (0, _uniq2.default)(items); // Remove duplicate items
	                                        _this2.setState({ cloneControlledTarget: items });
	                                    },
	                                    tag: 'ul'
	                                },
	                                cloneControlledTarget
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseRandom = __webpack_require__(37),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseUniq = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SetCache = __webpack_require__(40),
	    ...
	    createSet = __webpack_require__(70),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapCache = __webpack_require__(41),
	    cachePush = __webpack_require__(64);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Map = __webpack_require__(49),
	    ...
	    isKeyable = __webpack_require__(55);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hashHas = __webpack_require__(54);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Map = __webpack_require__(49),
	    assocGet = __webpack_require__(57),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstanceHandles = __webpack_require__(118);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(115);
	var ReactEmptyComponentRegistry = __webpack_require__(117);
	var ReactInstanceHandles = __webpack_require__(118);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactBrowserComponentMixin = __webpack_require__(163);
	var ReactComponentBrowserEnvironment = __webpack_require__(99);
	...
	function inject() {
	  ...
	  if (process.env.NODE_ENV !== 'production') {
	    ...
	    if (/[?&]react_perf\b/.test(url)) {
	      var ReactDefaultPerf = __webpack_require__(215);
